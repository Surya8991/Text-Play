...
export default function About() {
  const [myStyle, setMyStyle] = React.useState({
    //using useState hook to set the style of the text.
    color: "black",
    backgroundColor: "white",
  });
  const [btntext, setBtnText] = React.useState("Enable Dark Mode"); //using useState hook to set the text of the button.
  const toggleStyle = () => {
  ...
  return (
    ...
    <div classNameName="contaiber" style={myStyle}>
